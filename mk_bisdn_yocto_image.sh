...
./onie/build-config/scripts/onie-mk-demo.sh ${BISDN_ARCH} ${BISDN_ONIE_MACHINE} ${BISDN_ONIE_PLATFORM} ./bisdn/installer/ ./bisdn/machine/${PLATFORM_VENDOR}/${MACHINE}/platform.conf onie-bisdn-${MACHINE}.bin OS $*
