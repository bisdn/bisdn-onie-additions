...
../onie/build-config/scripts/onie-mk-demo.sh x86_64 ${BISDN_ONIE_MACHINE} ${BISDN_ONIE_PLATFORM} ../onie-bisdn-additions/bisdn/installer/ ../onie-bisdn-additions/bisdn/machine/${PLATFORM_VENDOR}/${MACHINE}/platform.conf onie-bisdn-${MACHINE}.bin OS $*
